...
function Footer() {
  return (
   <div className='w-full h-screen py-14 px-10 flex items-center justify-between  bg-[#F1F1F1]'>
   <div className='h-full w-1/2 flex flex-col justify-between '>
    <div className="headings">
        <h1 className='text-[6vw] font-bold uppercase md:-mb-4   leading-none tracking-tighter'>Eye-</h1>
        <h1 className='text-[6vw] font-bold uppercase  md:-mb-4  leading-none tracking-tighter'>Opening</h1>
    </div>
   ...
   <div className='  h-full w-1/2 flex flex-col justify-between ' >
   <div>
   <h1 className='text-[6vw]  -mb-4  leading-none font-bold uppercase tracking-tighter '>presentations</h1>
   </div>
   <div className='text-xl flex flex-col gap-2 font-medium'>
    ...
    <div className='text-xl font-medium opacity-50'>
